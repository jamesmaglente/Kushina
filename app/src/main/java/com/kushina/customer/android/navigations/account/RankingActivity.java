...
public class RankingActivity extends AppCompatActivity {
    ...
    public void onResume() {
        ...
        mAPI = new API(RankingActivity.this);
        mGlobals = new Globals(RankingActivity.this);
        mPreferences = new Preferences(RankingActivity.this);
                    ...
                    public void onResponseCallback(JSONObject result) {
                        ...
                        try {
                            ...
                            if (status_code == 200) {
                                ...
                                rvLeaderboard.setLayoutManager(new LinearLayoutManager(RankingActivity.this));
                                RVLeaderboardAdapter lbAdapter = new RVLeaderboardAdapter(RankingActivity.this, lbModel);
