...
import com.kushina.customer.android.navigations.addresses.AddEditAddressActivity;
import com.kushina.customer.android.navigations.addresses.AddressListActivity;
import com.kushina.customer.android.navigations.addresses.RVAddressListAdapter;
import com.kushina.customer.android.navigations.addresses.RVAddressListModel;
...
public class AddressListFragment extends Fragment {
    ...
    @BindView(R.id.ll_add) LinearLayout llAdd;List<RVAddressListModel> alModel;
                    ...
                    public void onResponseCallback(JSONObject result) {
                        ...
                        try {
                            ...
                            if (status_code == 200) {
                                ...
                                RVAddressListAdapter alAdapter = new RVAddressListAdapter(getActivity(), alModel);
