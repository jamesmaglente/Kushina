 ...
 */
public class AchievementsAndRewardsFragment extends Fragment {
    ...
    public AchievementsAndRewardsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_achievements_and_rewards, container, false);
                    ...
                    public void onResponseCallback(JSONObject result) {
                        ...
                        try {
                            ...
                            if (status_code == 200) {
                                ...
                                rvMilestones.setLayoutManager(new LinearLayoutManager(getActivity()));
                                RVMilestonesAdapter mAdapter = new RVMilestonesAdapter(getActivity(), mModel);
