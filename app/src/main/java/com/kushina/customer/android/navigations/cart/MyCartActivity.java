    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_choose_delivery_address:
                intent = new Intent(MyCartActivity.this, AddressListActivity.class);
            ...
            case R.id.btn_choose_payment_method:
                intent = new Intent(MyCartActivity.this, ChoosePaymentOptionsActivity.class);
                        ...
                        try {
                            ...
                            if (status_code == 200) {
                                ...
                                for (int i = 0; i < items.length(); i++) {
                                    ...
                                    mcModel.add(new RVMyCartModel(cart_item_id, item_id, quantity, remarks, code_id, current_stock, total_amount, status, category_id, category, description, long_description, image, sku, srp,discount, tax, likes, merchant_id, date_created));

                                }


                                rvMyCart.setHasFixedSize(true);
                                rvMyCart.setLayoutManager(new LinearLayoutManager(MyCartActivity.this));
                                RVMyCartAdapter mcAdapter = new RVMyCartAdapter(MyCartActivity.this, mcModel);
...
//
//                                    Intent intent = new Intent(MyCartActivity.this, ItemDetailsActivity.class);
