...
public class OrdersActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rv_orders_history) RecyclerView rvOrdersHistory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadOrders(getIntent().getIntExtra("status_id", 0));
                    ...
                    public void onResponseCallback(JSONObject result) {
                        ...
                        try {
                            ...
                            if (status_code == 200) {
                                ...
                                rvOrdersHistory.setLayoutManager(new LinearLayoutManager(OrdersActivity.this));
                                RVOrderHistoryAdapter ohAdapter = new RVOrderHistoryAdapter(OrdersActivity.this, ohModel);
